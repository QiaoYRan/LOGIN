...
def get_cora_casestudy(SEED=0):
    ...
    dataset = Planetoid('/storage/qiaoyr/TAPE/dataset/', data_name,
...
def parse_cora():
    path = '/storage/qiaoyr/TAPE/dataset/cora_orig/cora'
...
def get_raw_text_cora(use_text=False, seed=0):
    ...
    with open('/storage/qiaoyr/TAPE/dataset/cora_orig/mccallum/cora/papers')as f:
        lines = f.readlines()
    pid_filename = {}
    for line in lines:
        pid = line.split('\t')[0]
    ...
    path = '/storage/qiaoyr/TAPE/dataset/cora_orig/mccallum/cora/extractions/'
    text = []
