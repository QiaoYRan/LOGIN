...
class LMTrainer():
    def __init__(self, cfg, data, num_classes, text):
        ...
        self.output_dir = f'new_embeddings/{self.dataset_name}{self.use_gpt_str}/{self.model_name}-seed{self.seed}'
        self.ckpt_dir = f'prt_lm_1/{self.dataset_name}{self.use_gpt_str}/{self.model_name}-seed{self.seed}'
       ...
       #data, num_classes, text = load_data(
        ...
        prev_ckpt = f'prt_lm/{self.dataset_name}{self.use_gpt_str}/{self.model_name}-seed{self.seed}.ckpt'
        #prev_ckpt = f'prt_lm/{self.dataset_name}/{self.model_name}-seed{self.seed}.ckpt'
