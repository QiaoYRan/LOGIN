...
def get_raw_text_arxiv(use_text=False, seed=0):
    ...
    dataset = PygNodePropPredDataset(
        name='ogbn-arxiv', transform=T.ToSparseTensor(), root = '/storage/qiaoyr/TAPE/dataset/ogbn_arxiv')
    data = dataset[0]
    ...
    nodeidx2paperid = pd.read_csv(
        '/storage/qiaoyr/TAPE/dataset/ogbn_arxiv/mapping/nodeidx2paperid.csv.gz', compression='gzip')
