...
def get_cora_casestudy(SEED=0):
    ...
    dataset = Planetoid(DATASET_ROOT, data_name,
...
def parse_cora():
    path = f'{TAPE_ROOT}/dataset/cora_orig/cora'
...
def get_raw_text_cora(use_text=False, seed=0):
    ...
    with open(f'{TAPE_ROOT}/dataset/cora_orig/mccallum/cora/papers')as f:
        lines = f.readlines()
    pid_filename = {}
    for line in lines:
        pid = line.split('\t')[0]
    ...
    path = f'{TAPE_ROOT}/dataset/cora_orig/mccallum/cora/extractions/'
    text = []
